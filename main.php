<?php
/**
 * Plugin Name: Hide Checkout Fields for WooCommerce
 * Plugin URI: https://brightplugins.com/
 * Description: This plugin allows you to hide specific checkout fields on WooCommerce.
 * Version: 1.0
 * Author: Bright Plugins
 * Author URI: https://brightplugins.com
 * Text Domain: hidefields
...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    ...
    add_action('admin_notices', function () {
        ...
        $message = __('Oops! looks like WooCommerce is disabled. Please, enable it in order to use WP Custom Checkout.', 'hidefields');
